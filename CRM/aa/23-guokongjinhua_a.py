...
class GuokonglishuiSpider(scrapy.Spider):
    ...
    sess_guokongjinhua_a = requests.session()
    ...
    def parse(self, response):
        delivery_id = 'F617B115D6F3447983E94BB781231279'
        ...
        if is_enable == 1:
            self.number += 1
            html = self.sess_guokongjinhua_a.get(url=self.start_urls[0], headers=self.headers, verify=False)
            ...
            post_html = self.sess_guokongjinhua_a.post(url='http://www.gkzj.com:81/modal/login.php', data=data,
            ...
            data_html = self.sess_guokongjinhua_a.post(url='http://www.gkzj.com:81/modal/order.json.php',
                                                       data=data_data,
                                                       headers=self.headers,
                                                       verify=False)
            # print('*' * 1000)
            ...
            try:
                ...
                sql_data_crm_record = sql_crm_record.format(company_id, delivery_id, enterprise_name,
                                                            get_account, '23-guokongjinhua_a',
                ...
                print('guokongjinhua_a-登入失败:%s' % e)
