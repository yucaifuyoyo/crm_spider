...
class ZhejianglaiyiSpider(scrapy.Spider):
    name = 'zhejianglaiyi_a'
    allowed_domains = ['.com']
    start_urls = ['http://www.600216.com/lx/index.asp']
    headers = HEADERS
    ...
    # last = '2018-11-3'
    last = LAST
    sess_zhejianglaiyi_a = requests.session()
    ...
    def parse(self, response):
        delivery_id = 'F617B115D6F3447983E94BB781231280'
        ...
        if is_enable == 1:
            self.number += 1
            html = self.sess_zhejianglaiyi_a.get(url=self.start_urls[0], headers=self.headers, verify=False)
            image = self.sess_zhejianglaiyi_a.get(url='http://www.600216.com/lx/bmp.asp?flg=login',
            ...
            if SCRAPYD_TYPE == 1:
                ...
                files = r'{}{}static{}07-zhejianglaiyi'.format(path, symbol, symbol)
                if not os.path.exists(files):
                    os.makedirs(files)
                # print('path', path)
                with open(r'{}{}static{}07-zhejianglaiyi{}yzm_a.jpg'.format(path, symbol, symbol, symbol), 'wb') as f:
                    f.write(image.content)
                # 图片文件
                filename = r'{}{}static{}07-zhejianglaiyi{}yzm_a.jpg'.format(path, symbol, symbol, symbol)
            else:
                with open(r'./07-zhejianglaiyiyzm_a.jpg', 'wb') as f:
                    f.write(image.content)
                # 图片文件
                filename = r'./07-zhejianglaiyiyzm_a.jpg'
            ...
            # print('get_pwd', get_pwd)
            self.sess_zhejianglaiyi_a.post(url='http://www.600216.com/lx/index.asp', data=data, headers=self.headers,
                                           verify=False)
            data_html = self.sess_zhejianglaiyi_a.get(url='http://www.600216.com/lx/sa.asp?fir=1', headers=self.headers,
                                                      verify=False)
            try:
                re.findall(r'销售明细查询', data_html.content.decode('gb2312'))[0]
                # print('data_html.content.decode', data_html.content.decode('gb2312'))
                for i in range(1, 1000):
                    data_html = self.sess_zhejianglaiyi_a.get(
                        ...
                        url='http://www.600216.com/lx/sa.asp?mypage={}&searchcustom=&searchgoodsid=&searchDateBegin={}&searchDateEnd={}'.format(
                            i, self.fist, self.last), headers=self.headers, verify=False)
                    # print('data_html', data_html.content.decode('gb2312'))
                    # print('*' * 1000)
                    data_html = etree.HTML(data_html.content.decode('gb2312'))
                    data_len = int(len(data_html.xpath('//table/tr/td/table[1]/tr'))) - 2
                    # print(data_len)
                    md5 = hashlib.md5()
                    for i in range(data_len):
                        ...
                        try:
                            drug_name = data_html.xpath(
                                '//table/tr/td/table[1]/tr[%s]/td[5]/text()' % (i + 2))[0].strip()
                            if not drug_name:
                                drug_name = 1
                        except:
                            drug_name = 1
                        if drug_name != 1:
                            try:
                                ...
                                trade_name = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[6]/text()' % (i + 2))[0].strip()
                            except:
                                trade_name = ''
                            ...
                            try:
                                ...
                                drug_specification = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[7]/text()' % (i + 2))[0].strip()
                            except:
                                drug_specification = ''
                            ...
                            try:
                                ...
                                supplier_name = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[8]/text()' % (i + 2))[0].strip()
                            except:
                                supplier_name = ''
                            ...
                            try:
                                ...
                                drug_unit = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[12]/text()' % (i + 2))[0].strip()
                            except:
                                drug_unit = ''
                            ...
                            try:
                                ...
                                medical_community_member = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[3]/text()' % (i + 2))[0].strip()
                            except:
                            ...
                            try:
                                ...
                                drug_number = round(float(data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[11]/b/text()' % (i + 2))[0].strip()))
                                if drug_number < 0:
                                    bill_type = 4
                            ...
                            try:
                                ...
                                drug_batch = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[9]/b/text()' % (i + 2))[0].strip()
                            except:
                                drug_batch = ''
                            ...
                            try:
                                ...
                                valid_till = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[10]/text()' % (i + 2))[0].strip()
                            except:
                            ...
                            try:
                                ...
                                hospital_name = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[2]/text()' % (i + 2))[0].strip()
                            except:
                                hospital_name = ''
                            ...
                            try:
                                ...
                                hospital_address = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[4]/text()' % (i + 2))[0].strip()
                            except:
                                hospital_address = ''
                            ...
                            try:
                                ...
                                sell_time = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[1]/text()' % (i + 2))[0].strip()
                            except:
                            ...
                            try:
                                ...
                                drug_price = data_html.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[13]/text()' % (i + 2))[0].strip()
                            except:
                                drug_price = ''
                            ...
                            sql_data_crm = sql_crm.format(company_id, delivery_id, delivery_name, data_version,
                                                          data_type,
                                                          bill_type, drug_name, trade_name, medical_community_member,
                            ...
                            self.cursor.execute('select max(id) from order_metadata_zhejianglaiyi')
                    ...
                    try:
                        next_page = data_html.xpath('//*[@id="page"]/a[last()]/text()')[0]
                    except:
                        next_page = ''
                ...
                for i in range(1, 1000):
                    data_html_cai = self.sess_zhejianglaiyi_a.get(
                        ...
                        url='http://www.600216.com/lx/su.asp?mypage={}&searchSupply=&searchgoodsid=&searchDateBegin={}&searchDateEnd={}'.format(
                            i, self.fist, self.last), headers=self.headers, verify=False)
                    # print('data_html', data_html.content.decode('gb2312'))
                    # print('*' * 1000)
                    data_html_cai = etree.HTML(data_html_cai.content.decode('gb2312'))
                    data_len = int(len(data_html_cai.xpath('//table/tr/td/table[1]/tr'))) - 2
                    # print(data_len)
                    md5 = hashlib.md5()
                    for i in range(data_len):
                        # try:
                        ...
                        if drug_name != 1:
                            ...
                            try:
                                ...
                                drug_batch = data_html_cai.xpath(
                                    '//table/tr/td/table[1]/tr[%s]/td[7]/b/text()' % (i + 2))[0].strip()
                            except:
                                drug_batch = ''
                            ...
                            try:
                                ...
                                print('插入失败:%s  sql_data_crm_data:%s' % (e, sql_data_crm_data))
                    try:
                        next_page = data_html_cai.xpath('//*[@id="page"]/a[last()]/text()')[0]
                    except:
                        next_page = ''
                    # print('next_page', next_page)
                    if next_page != '下一页>':
                ...
                if MONTHS == 0:
                    self.cursor.execute(
                        "SELECT count(*) from order_metadata_zhejianglaiyi WHERE sell_time='{}' and delivery_name='{}'".format(
                            self.yesterday, enterprise_name))
                else:
                    month = int(str(self.fist).replace('-', '')[0: 6])
                    self.cursor.execute(
                        "SELECT count(*) from order_metadata_zhejianglaiyi WHERE month='{}' and delivery_name='{}'".format(
                ...
                sql_data_crm_record = sql_crm_record.format(company_id, delivery_id, enterprise_name,
                                                            get_account, '07-zhejianglaiyi_a',
                ...
                print('zhejianglaiyi_a-登入失败:%s' % e)
                if self.number < 4:
                    self.parse('aa')
                else:
                    create_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
