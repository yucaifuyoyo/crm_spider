...
class LongquanSpider(scrapy.Spider):
    name = 'hangzhoudehong'
    # allowed_domains = ['.']
    start_urls = ['http://122.224.183.22:2323/login.aspx']
    headers = HEADERS
    ...
    # last = '2018-11-01'
    last = LAST
    sess_hangzhoudehong = requests.session()
    ...
    def parse(self, response):
        delivery_id = 'F617B115D6F3447983E94BB781231265'
        ...
        if is_enable == 1:
            self.number += 1
            html = self.sess_hangzhoudehong.get(url=self.start_urls[0], headers=self.headers, verify=False)
            resp = etree.HTML(html.content.decode('utf-8'))
            __VIEWSTATE = resp.xpath('//*[@id="__VIEWSTATE"]/@value')[0]
            image = self.sess_hangzhoudehong.get(url='http://122.224.183.22:2323/Confirmation.aspx',
            ...
            login_html = self.sess_hangzhoudehong.post(url='http://122.224.183.22:2323/login.aspx',
                                                       data=Login_data, headers=self.headers, verify=False)
            # print('login_html', login_html.content.decode('utf-8'))
            # print('Login_data', Login_data)
            psot_data_html = self.sess_hangzhoudehong.get(url='http://122.224.183.22:2323/QueryModel.aspx?QID=76084',
            ...
            try:
                ...
                data_data = {
                    ...
                    "ctl00$ContentPlaceHolder3$ZBSQL": "QN_OUT_LIST_FOR_OUTER_NEW 194,',,{},{},',',1000,1,SUM_Amount|SUM_balance|'".format(
                        self.fist, self.last),
                    "ctl00$ContentPlaceHolder3$ZBALLCOLS": "sortid|BusiDate|BusiType|GoodsNo|GoodsName|spec|medicaltype|producer|price|Amount|balance|batchNo|ValidDate|CustomID|Custom|old_no",
                    "ctl00$ContentPlaceHolder3$ZBPAGEKEY": "",
                    "ctl00$ContentPlaceHolder3$SHOWSQL76084": "QN_OUT_LIST_FOR_OUTER_NEW 194,',,{},{},',',1000,1,SUM_Amount|SUM_balance|'".format(
                        self.fist, self.last),
                ...
                data_html = self.sess_hangzhoudehong.post(url='http://122.224.183.22:2323/QueryModel.aspx?QID=76084',
                ...
                for i in range(2, data_len):
                    ...
                    try:
                        ...
                        drug_name = \
                            data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[5]/text()' % i)[
                                0].strip()
                        if not drug_name:
                            drug_name = 1
                    except:
                    ...
                    if drug_name != 1:
                        try:
                            ...
                            drug_specification = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[6]/text()' % i)[
                                0].strip()
                        except:
                            drug_specification = ''
                        ...
                        try:
                            ...
                            supplier_name = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[8]/text()' % i)[
                                0].strip()
                        except:
                            supplier_name = ''
                        ...
                        try:
                            ...
                            bill_types = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[3]/text()' % i)[
                                0].strip()
                        ...
                        try:
                            ...
                            drug_number = round(float(data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[10]/span/text()' % i)[
                                                          0].strip()))
                        ...
                        try:
                            ...
                            drug_batch = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[12]/text()' % i)[
                                0].strip()
                        except:
                            drug_batch = ''
                        try:
                        ...
                        try:
                            ...
                            hospital_name = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[15]/text()' % i)[
                                0].strip()
                        except:
                            hospital_name = ''
                        ...
                        try:
                            ...
                            sell_time = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[2]/text()' % i)[
                                0].strip().replace('   ', '')
                        except:
                            sell_time = ''
                        ...
                        table_name = 'order_metadata_hangzhoudehong'
                        try:
                            # 价格
                            drug_price = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[9]/text()' % i)[
                                0].strip()
                        except:
                            drug_price = ''
                        try:
                            ...
                            drug_price_sum = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[11]/text()' % i)[
                                0].strip()
                        except:
                            drug_price_sum = ''
                        try:
                            ...
                            goods_id = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[16]/text()' % i)[
                                0].strip()
                        except:
                            goods_id = ''
                        try:
                            ...
                            dosage_form = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76084"]/tr[%s]/td[7]/text()' % i)[
                                0].strip()
                        except:
                            dosage_form = ''
                        ...
                        sql_crm = "insert into order_metadata_hangzhoudehong(company_id, delivery_id, delivery_name, data_version, data_type, bill_type, drug_name, drug_specification, supplier_name, drug_unit, drug_number, drug_batch, valid_till, hospital_name, hospital_address, sell_time, create_time, update_time, drug_price, drug_price_sum, goods_id, dosage_form, drug_hash, hospital_hash, stream_hash, month) values('{}', '{}', '{}', '{}', {}, '{}', '{}', '{}', '{}', '{}', {}, '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', '{}', {})"
                        ...
                        self.cursor.execute('select max(id) from order_metadata_hangzhoudehong')
                ...
                # ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                psot_data_html = self.sess_hangzhoudehong.get(
                    url='http://122.224.183.22:2323/QueryModel.aspx?QID=76083', headers=self.headers, verify=False)
                # print('psot_data_html', psot_data_html.content.decode('utf-8'))
                # print('*' * 1000)
                # try:
                psot_data_html = etree.HTML(psot_data_html.content.decode('utf-8'))
                ...
                data_data = {
                    ...
                    "ctl00$ContentPlaceHolder3$ZBDEFAULTVALUE": "",
                    "ctl00$ContentPlaceHolder3$ZBDATAKEYS": "",
                    "ctl00$ContentPlaceHolder3$ZBSQL": "QN_IN_LIST_FOR_OUTER_NEW 194,',,{},{},',',100,1,SUM_Amount|SUM_summoney|'".format(
                        self.fist, self.last),
                    "ctl00$ContentPlaceHolder3$ZBALLCOLS": "sortid|BusiDate|BusiType|GoodsNo|GoodsName|spec|medicaltype|producer|price|Amount|summoney|batchNo|ValidDate|Provider|old_no",
                    "ctl00$ContentPlaceHolder3$ZBPAGEKEY": "",
                    "ctl00$ContentPlaceHolder3$SHOWSQL76083": "QN_IN_LIST_FOR_OUTER_NEW 194,',,{},{},',',100,1,SUM_Amount|SUM_summoney|'".format(
                        self.fist, self.last),
                    "ctl00$ContentPlaceHolder3$ZBEdit1": "",
                    "ctl00$ContentPlaceHolder3$ZBEdit2": "",
                    "ctl00$ContentPlaceHolder3$ZBEdit3": "",
                ...
                data_html = self.sess_hangzhoudehong.post(url='http://122.224.183.22:2323/QueryModel.aspx?QID=76083',
                                                          data=data_data, headers=self.headers,
                                                          verify=False)
                # print('data_html_jin', data_html.content.decode('utf-8'))
                # print('*' * 1000)
                # print('data_data_jin', data_data)
                # print('*' * 1000)
                data_html = etree.HTML(data_html.content.decode('utf-8'))
                ...
                for i in range(2, data_len):
                    ...
                    try:
                        ...
                        drug_name = \
                            data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[5]/text()' % i)[
                                0].strip()
                        if not drug_name:
                            drug_name = 1
                    except:
                    ...
                    if drug_name != 1:
                        try:
                            # 药品规格
                            drug_specification = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[6]/text()' % i)[
                                0].strip()
                        except:
                            drug_specification = ''
                        ...
                        try:
                            # 生产企业
                            supplier_name = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[8]/text()' % i)[
                                0].strip()
                        except:
                            supplier_name = ''
                        ...
                        try:
                            # 计量单位(瓶,盒等)
                            bill_types = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[3]/text()' % i)[
                                0].strip()
                            if '进货' in bill_types:
                                bill_type = 1
                            else:
                        ...
                        try:
                            # 数量
                            drug_number = round(float(data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[10]/text()' % i)[
                                                          0].strip()))
                        ...
                        try:
                            # 批号
                            drug_batch = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[12]/text()' % i)[
                                0].strip()
                        except:
                            drug_batch = ''
                        try:
                            # 有效期至,格式:yyyy-MM-dd
                            valid_till = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[13]/text()' % i)[
                                0].strip()
                            if not valid_till:
                                valid_till = '2000-01-01'
                        except:
                        ...
                        try:
                            # 销售(制单)时间,格式:yyyy-MM-dd
                            sell_time = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[2]/text()' % i)[
                                0].strip().replace('  ', '')
                        except:
                            sell_time = ''
                        create_time = time.strftime("%Y-%m-%d %H:%M:%S", time.localtime())
                        ...
                        try:
                            # 商品id
                            goods_id = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[15]/text()' % i)[
                                0].strip()
                        except:
                            goods_id = ''
                        try:
                            # 剂型
                            dosage_form = data_html.xpath(
                                '//*[@id="ctl00_ContentPlaceHolder3_GridBlock76083"]/tr[%s]/td[7]/text()' % i)[
                                0].strip()
                        except:
                            dosage_form = ''
                        drug_hashs = "%s %s %s %s" % (drug_name, drug_specification, delivery_id, supplier_name)
                ...
                if MONTHS == 0:
                    self.cursor.execute(
                        "SELECT count(*) from order_metadata_hangzhoudehong WHERE sell_time='{}' and delivery_name='{}'".format(
                            self.yesterday, enterprise_name))
                else:
                    month = int(str(self.fist).replace('-', '')[0: 6])
                    self.cursor.execute(
                        "SELECT count(*) from order_metadata_hangzhoudehong WHERE month='{}' and delivery_name='{}'".format(
