    ...
    def parse(self, response):
        ...
        if is_enable == 1:
            ...
            if SCRAPYD_TYPE == 1:
                ...
                # print('path', path)
                files = r'{}{}static{}21-jiaxingyinte'.format(path, symbol, symbol)
                if not os.path.exists(files):
                    os.makedirs(files)
                with open(r'{}{}static{}21-jiaxingyinte{}yzm.jpg'.format(path, symbol, symbol, symbol), 'wb') as f:
                    f.write(image.content)
                # 图片文件
                filename = r'{}{}static{}21-jiaxingyinte{}yzm.jpg'.format(path, symbol, symbol, symbol)
            else:
