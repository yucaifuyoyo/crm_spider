...
class XiaoshanyiyuanSpider(scrapy.Spider):
    name = 'xiaoshanyiyuan'
    allowed_domains = ['.com']
    start_urls = ['http://www.hzxsyy.com.cn:8080/syslogin.aspx?result=5&txtCompanyID=22']
    headers = HEADERS
    time_stamp = str(int(time.time() * 1000))
    yesterday = YESTERDAY
    fist = FIST
    last = LAST
    sess_xiaoshanyiyuan = requests.session()
